...
public class VendasController {
	...
	public ModelAndView pesquisar(VendaFilter vendaFilter, @PageableDefault(size = 3) Pageable pageable, HttpServletRequest httpServletRequest) {
		...
		PageWrapper<Venda> paginaWrapper = new PageWrapper<>(vendasRepository.filtrar(vendaFilter, pageable), httpServletRequest);
	...
	public @ResponseBody List<VendaOrigem> vendasPorNacionalidade() {
		return this.vendasRepository.totalPorOrigem();
	}
